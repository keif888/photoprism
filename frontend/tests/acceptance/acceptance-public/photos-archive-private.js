...
test.meta("testID", "photos-archive-private-001").meta({ type: "short", mode: "public" })(
  ...
  async (t) => {
    ...
    //await helperRevertPhoto(t, SecondVideoUid);
    await helperRevertPhoto(t, ThirdVideoUid);
...
test.meta("testID", "photos-archive-private-002").meta({ type: "short", mode: "public" })(
  ...
  async (t) => {
    ...
    await helperRevertPhoto(t, SecondPhotoUid);
    await helperRevertPhoto(t, FirstVideoUid);
    await helperRevertPhoto(t, FirstPrivatePhotoUid);
    await helperRevertPhoto(t, FirstReviewPhotoUid);
...
test.meta("testID", "photos-archive-private-003").meta({ mode: "public" })(
  ...
  async (t) => {
    if (t.browser.platform === "mobile") {
      ...
      await helperRevertPhoto(t, MonochromePhoto);
      ...
      await helperRevertPhoto(t, PanoramaPhoto);
      ...
      await helperRevertPhoto(t, StackedPhoto);
      ...
      await helperRevertPhoto(t, CalendarPhoto);
      ...
      await helperRevertPhoto(t, MomentPhoto);
      ...
      await helperRevertPhoto(t, StatesPhoto);
      ...
      await helperRevertPhoto(t, LabelPhoto);
      ...
      await helperRevertPhoto(t, SubjectPhoto);
      ...
      await helperRevertPhoto(t, FolderPhoto);
...
test.meta("testID", "photos-archive-private-004").meta({ type: "short", mode: "public" })(
  ...
  async (t) => {
    if (t.browser.platform === "mobile") {
      ...
      await helperRevertPhoto(t, AlbumPhoto);
