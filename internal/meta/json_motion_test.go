...
func TestJSON_Motion(t *testing.T) {
	t.Run("google_pixel2.jpg.json", func(t *testing.T) {
		...
		assert.InDelta(t, 35.423069, data.Lat, 0.0000009)
		assert.InDelta(t, -78.652122, data.Lng, 0.0000009)
	...
	t.Run("google_pixel4a.jpg.json", func(t *testing.T) {
		...
		assert.InDelta(t, 35.778152, data.Lat, 0.0000009)
		assert.InDelta(t, -78.636875, data.Lng, 0.0000009)
		assert.Equal(t, "Google", data.CameraMake)
	...
	t.Run("google_pixel6.jpg.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 48.610028, data.Lat, 0.0000009)
		assert.InDelta(t, 8.861558, data.Lng, 0.0000009)
		assert.Equal(t, "Google", data.CameraMake)
	...
	t.Run("google_pixel7pro.jpg.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 52.706361, data.Lat, 0.0000009)
		assert.InDelta(t, -2.760594, data.Lng, 0.0000009)
		assert.Equal(t, "Google", data.CameraMake)
	...
	t.Run("samsung_galaxys20.mp4.json", func(t *testing.T) {
		...
		assert.Equal(t, 6, data.Orientation)
		assert.InDelta(t, 48.4565, data.Lat, 0.0000009)
		assert.InDelta(t, 35.072, data.Lng, 0.0000009)
	...
	t.Run("samsung_galaxys20fe.heif.json", func(t *testing.T) {
		...
		assert.Equal(t, 4032, data.ActualHeight())
		assert.Equal(t, 6, data.Orientation)
		assert.InDelta(t, 51.433469, data.Lat, 0.0000009)
		assert.InDelta(t, 12.110732, data.Lng, 0.0000009)
		assert.Equal(t, "samsung", data.CameraMake)
