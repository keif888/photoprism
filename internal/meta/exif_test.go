...
func TestExif(t *testing.T) {
	...
	t.Run("photoshop.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 52.459690, data.Lat, 0.0000009)
		assert.InDelta(t, 13.321832, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("ladybug.jpg", func(t *testing.T) {
		...
		assert.Equal(t, 540, data.Height)
		assert.Equal(t, 720, data.Width)
		assert.InDelta(t, 51.254852, data.Lat, 0.0000009)
		assert.InDelta(t, 7.389468, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("iphone_7.heic", func(t *testing.T) {
		...
		assert.InDelta(t, 34.797450, data.Lat, 0.0000009)
		assert.InDelta(t, 134.764633, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("gps-2000.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, -38.405195, data.Lat, 0.0000009)
		assert.InDelta(t, 144.188958, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
		assert.Equal(t, "", data.Exposure)
		assert.Equal(t, "", data.CameraMake)
		assert.Equal(t, "", data.CameraModel)
	...
	t.Run("ship.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 53.12349, data.Lat, 0.0000009)
		assert.InDelta(t, 18.00152, data.Lng, 0.0000009)
	...
	t.Run("huawei-gps-error.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 48.302778, data.Lat, 0.0000009)
		assert.InDelta(t, 8.927500, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("panorama360.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 59.840833, data.Lat, 0.0000009)
		assert.InDelta(t, 30.510000, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("digikam.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 52.460522, data.Lat, 0.0000009)
		assert.InDelta(t, 13.331402, data.Lng, 0.0000009)
	...
	t.Run("Iceland-P3.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 65.055578, data.Lat, 0.0000009)
		assert.InDelta(t, -16.625702, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("Iceland-sRGB.jpg", func(t *testing.T) {
		...
		assert.Equal(t, 600, data.Width)
		assert.InDelta(t, 65.055578, data.Lat, 0.0000009)
		assert.InDelta(t, -16.625703, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
		assert.Equal(t, "1/8", data.Exposure)
		assert.Equal(t, "NIKON CORPORATION", data.CameraMake)
		assert.Equal(t, "NIKON D800E", data.CameraModel)
	...
	t.Run("buggy_panorama.jpg", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 33.640009, data.Lat, 0.0000009)
		assert.InDelta(t, 103.480000, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	})
