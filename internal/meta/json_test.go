...
func TestJSON(t *testing.T) {
	t.Run("mov.json", func(t *testing.T) {
		...
		assert.InDelta(t, 52.5035, data.Lat, 0.0000009)
		assert.InDelta(t, 13.4098, data.Lng, 0.0000009)
	...
	t.Run("iphone-mov.json", func(t *testing.T) {
		...
		assert.InDelta(t, 52.4587, data.Lat, 0.0000009)
		assert.InDelta(t, 13.4593, data.Lng, 0.0000009)
		assert.Equal(t, "Apple", data.CameraMake)
	...
	t.Run("gopher-telegram.json", func(t *testing.T) {
		...
		assert.Equal(t, 480, data.ActualHeight())
		assert.Equal(t, 1, data.Orientation)
		assert.Equal(t, float64(0), data.Lat)
		assert.Equal(t, float64(0), data.Lng)
	...
	t.Run("gopher-original.json", func(t *testing.T) {
		...
		assert.Equal(t, 6, data.Orientation)
		assert.InDelta(t, 52.4596, data.Lat, 0.0000009)
		assert.InDelta(t, 13.3218, data.Lng, 0.0000009)
		assert.Equal(t, "", data.CameraMake)
		assert.Equal(t, "", data.CameraModel)
		assert.Equal(t, "", data.LensModel)
	})
	...
	t.Run("berlin-landscape.json", func(t *testing.T) {
		...
		assert.Equal(t, 1080, data.Height)
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 52.4649, data.Lat, 0.0000009)
		assert.InDelta(t, 13.3148, data.Lng, 0.0000009)
		assert.Equal(t, "", data.CameraMake)
		assert.Equal(t, "", data.CameraModel)
		assert.Equal(t, "", data.LensModel)
	})
	...
	t.Run("photoshop.json", func(t *testing.T) {
		...
		assert.Equal(t, "0s", data.Duration.String())
		assert.InDelta(t, 52.459688, data.Lat, 0.0000009)
		assert.InDelta(t, 13.321830, data.Lng, 0.0000009)
	...
	t.Run("uuid-original.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 48.300003, data.Lat, 0.0000009)
		assert.InDelta(t, 8.929067, data.Lng, 0.0000009)
		assert.Equal(t, "Apple", data.CameraMake)
		assert.Equal(t, "iPhone SE", data.CameraModel)
	...
	t.Run("gphotos-1.json", func(t *testing.T) {
		...
		assert.Equal(t, "Europe/Berlin", data.TimeZone)
		assert.InDelta(t, 52.508522, data.Lat, 0.0000009)
		assert.InDelta(t, 13.443206, data.Lng, 0.0000009)
	...
	t.Run("gphotos-2.json", func(t *testing.T) {
		...
		assert.Equal(t, "Europe/Berlin", data.TimeZone)
		assert.InDelta(t, 52.5107943, data.Lat, 0.0000009)
		assert.InDelta(t, 13.4563869, data.Lng, 0.0000009)
	...
	t.Run("gphotos-4.json", func(t *testing.T) {
		...
		assert.Equal(t, "Europe/Berlin", data.TimeZone)
		assert.InDelta(t, 52.49966666666667, data.Lat, 0.0000009)
		assert.InDelta(t, 13.422333333333333, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
		assert.Equal(t, 0, data.Views)
	})
	...
	t.Run("panorama360.json", func(t *testing.T) {
		...
		assert.InDelta(t, 59.84083333, data.Lat, 0.0000009)
		assert.InDelta(t, 30.51000000, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	...
	t.Run("digikam.json", func(t *testing.T) {
		...
		assert.InDelta(t, 52.46052222, data.Lat, 0.0000009)
		assert.InDelta(t, 13.33140278, data.Lng, 0.0000009)
	...
	t.Run("date.mov.json", func(t *testing.T) {
		...
		assert.Equal(t, 1920, data.ActualHeight())
		assert.Equal(t, 6, data.Orientation)
		assert.InDelta(t, 55.5636, data.Lat, 0.0000009)
		assert.InDelta(t, 37.9824, data.Lng, 0.0000009)
		assert.Equal(t, "Apple", data.CameraMake)
	...
	t.Run("date-creation.mov.json", func(t *testing.T) {
		...
		assert.Equal(t, 1080, data.ActualHeight())
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 55.7579, data.Lat, 0.0000009)
		assert.InDelta(t, 37.6197, data.Lng, 0.0000009)
		assert.Equal(t, "Apple", data.CameraMake)
		assert.Equal(t, "iPhone 6 Plus", data.CameraModel)
		assert.Equal(t, "", data.LensModel)
	})
	...
	t.Run("date-iphonex.mov.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 40.7696, data.Lat, 0.0000009)
		assert.InDelta(t, -73.9964, data.Lng, 0.0000009)
		assert.Equal(t, "Apple", data.CameraMake)
	...
	t.Run("quicktimeutc_on.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 43.5683, data.Lat, 0.0000009)
		assert.InDelta(t, 4.5645, data.Lng, 0.0000009)
	})
	...
	t.Run("cr2_num_off.json", func(t *testing.T) {
		...
		assert.InDelta(t, 32.84354444, data.Lat, 0.0000009)
		assert.InDelta(t, -117.28024722, data.Lng, 0.0000009)
	...
	t.Run("cr2_num_on.json", func(t *testing.T) {
		...
		assert.Equal(t, 3648, data.Height)
		assert.Equal(t, 5472, data.Width)
		assert.InDelta(t, 32.843545, data.Lat, 0.0000009)
		assert.InDelta(t, -117.280248333333, data.Lng, 0.0000009)
		assert.Equal(t, 18, clean.Altitude(data.Altitude))
	...
	t.Run("Iceland-P3.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, 65.05557778, data.Lat, 0.0000009)
		assert.InDelta(t, -16.62570278, data.Lng, 0.0000009)
		assert.Equal(t, 30, clean.Altitude(data.Altitude))
	...
	t.Run("buggy_panorama.json", func(t *testing.T) {
		...
		assert.Equal(t, 1, data.Orientation)
		assert.InDelta(t, 33.640008888889, data.Lat, 0.0000009)
		assert.InDelta(t, 103.48, data.Lng, 0.0000009)
		assert.Equal(t, 0.0, data.Altitude)
	})
	...
	t.Run("altitude.json", func(t *testing.T) {
		...
		assert.Equal(t, "", data.LensModel)
		assert.InDelta(t, 45.75285, data.Lat, 0.0000009)
		assert.InDelta(t, 33.221977, data.Lng, 0.0000009)
