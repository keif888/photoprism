...
func TestMediaFile_Exif_JPEG(t *testing.T) {
	...
	t.Run("elephants.jpg", func(t *testing.T) {
		...
		assert.InDelta(t, -33.45347, data.Lat, 0.0000009)
		assert.InDelta(t, 25.764645, data.Lng, 0.0000009)
...
func TestMediaFile_Exif_DNG(t *testing.T) {
	...
	assert.Equal(t, float64(0), info.Lat)
	assert.Equal(t, float64(0), info.Lng)
	assert.Equal(t, 0.0, info.Altitude)
