...
func TestMediaFile_HEIC(t *testing.T) {
	...
	t.Run("iphone_7.heic", func(t *testing.T) {
		...
		assert.InDelta(t, 34.79745, jpegInfo.Lat, 0.0000009)
		assert.InDelta(t, 134.764633, jpegInfo.Lng, 0.0000009)
	...
	t.Run("iphone_15_pro.heic", func(t *testing.T) {
		...
		assert.InDelta(t, 52.459606, jpegInfo.Lat, 0.0000009)
		assert.InDelta(t, 13.321841, jpegInfo.Lng, 0.0000009)
