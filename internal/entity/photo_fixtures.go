...
var PhotoFixtures = PhotoMap{
	...
	"Photo02": { //JPG, Indexed, No Geo-information
		...
		Files:            []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000002, "cake", 20, "image"),
			LabelFixtures.PhotoLabel(1000002, "cow", 100, SrcManual)},
		CreatedAt:  time.Date(2009, 1, 1, 0, 0, 0, 0, time.UTC),
	...
	"Photo03": { // JPG + JPG (same instance ID) + MP4, Indexed, Place from metadata
		...
		CreatedAt:  time.Date(2009, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2008, 1, 1, 0, 0, 0, 0, time.UTC),
		EditedAt:   Time("2022-01-01T00:00:00Z"),
		CheckedAt:  &checkedTime,
		DeletedAt:  nil,
		PhotoColor: 12,
		PhotoStack: 0,
	...
	"Photo04": { //JPG, Indexed, Place estimated
		...
		EditedAt:   Time("2020-06-01T00:00:00Z"),
		CheckedAt:  &checkedTime,
		DeletedAt:  nil,
		PhotoColor: 12,
		PhotoStack: 0,
	...
	"Photo15": { // JPG FileMissing = true, Indexed
		...
		Lens:             LensFixtures.Pointer("lens-f-380"),
		LensID:           LensFixtures.Pointer("lens-f-380").ID,
		Details:          DetailsFixtures.Pointer("non-photographic", 1000015),
		Keywords:         []Keyword{},
		Albums:           []Album{},
		Files:            []File{},
	...
	"Photo25": { // JPG, Indexed, Photo edited, Panorama true, Unstacked
		...
		PhotoCaption:     "",
		CaptionSrc:       "",
		PhotoDescription: "legacy description",
		DescriptionSrc:   "meta",
		PhotoPath:        "2007/12",
	...
	"Photo55": { //JPG + PDF, indexed
		...
		PhotoType:        "document",
		TypeSrc:          "",
		PhotoTitle:       "Bachelor Thesis 2022",
		TitleSrc:         SrcMeta,
		PhotoCaption:     "",
		CaptionSrc:       "",
		PhotoPath:        "education/university",
		PhotoName:        "BSc-Thesis",
		OriginalName:     "",
		PhotoFavorite:    false,
		PhotoPrivate:     false,
		PhotoScan:        false,
	...
	"Photo56": { //JPG
		...
		Lens:             LensFixtures.Pointer("lens-f-380"),
		LensID:           LensFixtures.Pointer("lens-f-380").ID,
		Details:          DetailsFixtures.Pointer("1000057", 1000057),
		Keywords: []Keyword{
			KeywordFixtures.Get("bridge"),
			KeywordFixtures.Get("beach"),
		},
		Albums: []Album{
			AlbumFixtures.Get("holiday-2030"),
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000057, "flower", 38, SrcImage),
			LabelFixtures.PhotoLabel(1000057, "cake", 38, SrcManual),
			LabelFixtures.PhotoLabel(1000057, "cow", 25, SrcKeyword),
			LabelFixtures.PhotoLabel(1000057, "landscape", 0, SrcLocation),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
	...
	"Photo57": { //JPG
		...
		TakenAtLocal:     time.Date(2023, 11, 12, 9, 8, 18, 0, time.UTC),
		TakenSrc:         SrcMeta,
		PhotoType:        "image",
		TypeSrc:          SrcAuto,
		PhotoTitle:       "Dog at the beach",
		...
		Lens:             LensFixtures.Pointer("lens-f-380"),
		LensID:           LensFixtures.Pointer("lens-f-380").ID,
		Details:          DetailsFixtures.Pointer("1000058", 1000058),
		Keywords: []Keyword{
			KeywordFixtures.Get("bridge"),
			KeywordFixtures.Get("beach"),
		},
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000058, "flower", 38, SrcImage),
			LabelFixtures.PhotoLabel(1000058, "cake", 0, SrcManual),
			LabelFixtures.PhotoLabel(1000058, "cow", 25, SrcKeyword),
			LabelFixtures.PhotoLabel(1000058, "landscape", 0, SrcLocation),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
	...
	"Photo58": { //JPG + MP4
		...
		TakenAtLocal:     time.Date(2018, 12, 01, 9, 8, 18, 0, time.UTC),
		TakenSrc:         SrcMeta,
		PhotoType:        "video",
		TypeSrc:          SrcAuto,
		PhotoTitle:       "Christmas Tree / 2018",
		TitleSrc:         SrcMeta,
		PhotoCaption:     "Our beautiful christmas tree",
		CaptionSrc:       SrcManual,
		PhotoPath:        "2018/12",
		PhotoName:        "VID_58",
		OriginalName:     "",
		...
		Lens:             LensFixtures.Pointer("4.15mm-f/2.2"),
		LensID:           LensFixtures.Pointer("4.15mm-f/2.2").ID,
		Details:          DetailsFixtures.Pointer("1000059", 1000059),
		Keywords: []Keyword{
			KeywordFixtures.Get("bridge"),
			KeywordFixtures.Get("flower"),
		},
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000059, "&friendship", 38, SrcImage),
			LabelFixtures.PhotoLabel(1000059, "cake", 15, SrcTitle),
			LabelFixtures.PhotoLabel(1000059, "cow", 15, SrcCaption),
			LabelFixtures.PhotoLabel(1000059, "landscape", 15, SrcSubject),
			LabelFixtures.PhotoLabel(1000059, "construction&failure", 0, SrcBatch),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
