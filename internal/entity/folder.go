...
type Folder struct {
	...
	Root              string     `gorm:"type:VARBINARY(16);unique_index:idx_folders_path_root;" json:"Root" yaml:"Root,omitempty"`
	...
	FolderCountry     string     `gorm:"type:VARBINARY(2);index:idx_folders_country_year_month;" json:"Country" yaml:"Country,omitempty"`
