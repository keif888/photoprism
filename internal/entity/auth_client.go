...
type Client struct {
	...
	NodeUUID     string          `gorm:"type:VARBINARY(64);index;" json:"NodeUUID,omitempty" yaml:"NodeUUID,omitempty"`
	...
	NameSrc      string          `gorm:"type:VARBINARY(8);" json:"NameSrc,omitempty" yaml:"NameSrc,omitempty"`
	ClientRole   string          `gorm:"size:64;" json:"ClientRole" yaml:"ClientRole,omitempty"`
	ClientType   string          `gorm:"type:VARBINARY(16)" json:"ClientType" yaml:"ClientType,omitempty"`
	ClientURL    string          `gorm:"type:VARBINARY(255);column:client_url;" json:"ClientURL" yaml:"ClientURL,omitempty"`
	CallbackURL  string          `gorm:"type:VARBINARY(255);column:callback_url;" json:"CallbackURL" yaml:"CallbackURL,omitempty"`
	...
	AuthScope    string          `gorm:"size:1024;" json:"AuthScope" yaml:"AuthScope,omitempty"`
	...
	RefreshToken string          `gorm:"type:VARBINARY(2048);column:refresh_token;" json:"-" yaml:"-"`
	IdToken      string          `gorm:"type:VARBINARY(2048);column:id_token;" json:"IdToken,omitempty" yaml:"IdToken,omitempty"`
