...
type Session struct {
	...
	user          *User           `gorm:"-" yaml:"-"`
	ClientUID     string          `gorm:"type:VARBINARY(42);index;" json:"ClientUID" yaml:"ClientUID,omitempty"`
	...
	GrantType     string          `gorm:"type:VARBINARY(64);" json:"GrantType" yaml:"GrantType,omitempty"`
	...
	AccessToken   string          `gorm:"type:VARBINARY(4096);column:access_token;" json:"-" yaml:"-"`
	...
	RefID         string          `gorm:"type:VARBINARY(16);" json:"ID" yaml:"-"`
