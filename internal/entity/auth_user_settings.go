...
type UserSettings struct {
	...
	UIStartPage          string    `gorm:"size:64;column:ui_start_page;" json:"UIStartPage,omitempty" yaml:"UIStartPage,omitempty"`
	...
	DownloadOriginals    int       `json:"DownloadOriginals,omitempty" yaml:"DownloadOriginals,omitempty"`
	DownloadMediaRaw     int       `json:"DownloadMediaRaw,omitempty" yaml:"DownloadMediaRaw,omitempty"`
	DownloadMediaSidecar int       `json:"DownloadMediaSidecar,omitempty" yaml:"DownloadMediaSidecar,omitempty"`
	SearchListView       int       `json:"SearchListView,omitempty" yaml:"SearchListView,omitempty"`
	SearchShowTitles     int       `json:"SearchShowTitles,omitempty" yaml:"SearchShowTitles,omitempty"`
	SearchShowCaptions   int       `json:"SearchShowCaptions,omitempty" yaml:"SearchShowCaptions,omitempty"`
...
func NewUserSettings(uid string) *UserSettings {
	return &UserSettings{UserUID: uid, UIStartPage: "default"}
}
