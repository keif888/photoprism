...
acceptance:
	...
	(cd frontend &&	npm run testcafe -- "chrome --headless=new" --test-grep "^(Proxy)\:*" --test-meta mode=public --config-file ./testcaferc.proxy.json "tests/acceptance")
acceptance-short:
	...
	(cd frontend &&	npm run testcafe -- "chrome --headless=new" --test-grep "^(Proxy)\:*" --test-meta mode=public,type=short --config-file ./testcaferc.proxy.json "tests/acceptance")
acceptance-firefox:
	...
	(cd frontend &&	npm run testcafe -- firefox:headless --test-grep "^(Proxy)\:*" --test-meta mode=public --config-file ./testcaferc.proxy.json "tests/acceptance")
acceptance-auth:
	...
	(cd frontend &&	npm run testcafe -- "chrome --headless=new" --test-grep "^(Proxy)\:*" --test-meta mode=auth --config-file ./testcaferc.proxy.json "tests/acceptance")
acceptance-auth-short:
	...
	(cd frontend &&	npm run testcafe -- "chrome --headless=new" --test-grep "^(Proxy)\:*" --test-meta mode=auth,type=short --config-file ./testcaferc.proxy.json "tests/acceptance")
acceptance-auth-firefox:
	...
	(cd frontend &&	npm run testcafe -- firefox:headless --test-grep "^(Proxy)\:*" --test-meta mode=auth --config-file ./testcaferc.proxy.json "tests/acceptance")
reset-mariadb:
...
docker-develop-armv7:
	docker pull --platform=arm ubuntu:noble
